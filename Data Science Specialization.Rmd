...
* It is any variable whose value is enclosed by single / double square brackets.    
...
* It is equivalent to indexing items in a list, only this time you are giving a certain range where the ***starting*** value will be included but the ***ending value*** won't.  
...
* Unlike normal lists, they can contain only one type of data in them and you can do mathematical operations on the items in them. Example:  
