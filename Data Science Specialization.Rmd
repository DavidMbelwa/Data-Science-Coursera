...
* You'll have to download and install the "reticulate" package in RStudio in order to be able to run a Python execution environment in RStudio. Follow the following steps:  
...
3. Run this command to initiate the Python shell (The execution environment): ` repl_python() `. When running it for the first time, it would download the python shell and install it in RStudio. It might prompt you to answer some questions during the downloading process. Answer accordingly.  
