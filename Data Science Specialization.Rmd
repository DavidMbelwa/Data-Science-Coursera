...
* It is a powerful statistical package allowing various data manipulation capabilities on data tables created using 2D Numpy arrays.  
...
* First create a list of variables you want to discriminate with..  
  ...
  ```python
    ...
    condition = posionous_flowers["color"].isin(colors)
