...
##### 3. Errors.  
  ...
  4. `AttributeError` : When an un-applicable python ***method*** is used to a certain type of variable. Python ***Methods*** are small instructions attached to different types of Python variables depending on their nature. These instructions modify the specified variable in a certain manner and when a method is applied to a variable it was not meant to operate with, it throws back this `AttributeError`. We will touch more on python methods later.  
...
##### 2. Importing part of the Package / Subpackage
##### 3. Importing a Method in a Custom Name
