...
## What is Python
* It is a simple, easy-to-understand computer language developed in 1980's.  
* It uses common English words as instructions and a simple writing format that is easy to understand when you know the basics.  
* It is also a powerful computer language, considering the applications it can be used at and the open source community behind it. It has been used for web development, data science, writing applications and more.  



## Types of Data That Can Be Entered And Processed in Python  

### 1. Strings
* These are values that are entered as lettered words  
* 
* 
...
### Operations Possible on Numbers
...
#### Requirements For Using Python Language
1. No previous programming knowledge needed.  
2. A computer  
3. A text editor for programming such as Notepad++, Atom etc. Atom is recommended because it behaves similarly in Windows, Mac and Linux computers. Get it [**here**](https://atom.io/)  
4. Python itself. You can download it [**here**](https://www.python.org/downloads/).  
